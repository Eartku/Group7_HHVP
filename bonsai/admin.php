      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsFurni">
          <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
            ...
            <li>
              <a href="admin/admin_type.php" class="hover-text-glow-small"
                 style="font-size: 13px"
                >LOẠI SẢN PHẨM</a
              >
            </li>
            <li>
              <a href="admin/admin_product.php" class="hover-text-glow-small"
                 style="font-size: 13px"
                >SẢN PHẨM</a
              >
            </li>
             <li>
              <a href="admin/admin_importproduct.php" class="hover-text-glow-small"
                 style="font-size: 13px"
                >NHẬP SẢN PHẨM</ax
              >
            </li>
             <li>
              <a href="admin/admin_sellingprice.php" class="hover-text-glow-small"
                 style="font-size: 13px"
                >GIÁ BÁN</a
              >
            </li>
            <li>
              <a  href="admin/admin_order.php" class="hover-text-glow-small"
                 style="font-size: 13px"
                >ĐƠN HÀNG</a
              >
            </li>
            <li>
              <a href="admin/admin_stock1.php" class="hover-text-glow-small"
                 style="font-size: 13px"
                >KHO</a
              >
            </li>
