...
-- Thời gian đã tạo: Th3 20, 2026 lúc 01:00 PM
...
(2, 'Cây nội thất', NULL, NULL, 'active'),
...
(3, 'Huy', '$2y$10$m6IUEwTMNtQ0FMKsRgR8X.AeI2sZTJ5WRS8VcgTTEe86BGaKhj1Yy', 'Trần Nhựt Huy', '320/30 Trần Bình Trọng', '0962713941', 'trannhuthuy897@gmail.com', 'active', 'customer', '1773977405_thumb-1920-1011626.png', NULL, NULL, '2026-03-19 21:00:43', '2026-03-20 12:05:16'),
(9, 'Huyz', '$2y$10$m6IUEwTMNtQ0FMKsRgR8X.AeI2sZTJ5WRS8VcgTTEe86BGaKhj1Yy', 'Trần Nhựt Huy', '320/30 Trần Bình Trọng', '0962713941', 'trannhuthuy999@gmail.com', 'active', 'admin', '1773977405_thumb-1920-1011626.png', NULL, NULL, '2026-03-19 21:00:43', '2026-03-20 12:05:16');
...
--
ALTER TABLE `size`
  ADD CONSTRAINT `size_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE;
COMMIT;
