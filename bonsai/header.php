...
<nav class="custom-navbar navbar navbar-expand-md navbar-dark bg-dark" aria-label="Bonsai navigation bar">
  <div class="container">
    <a class="navbar-brand" href="dashboard.php">BonSai<span>🌱</span></a>
    ...
    <div class="collapse navbar-collapse" id="navbarsFurni">
      <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
        ...
        <li><a href="shop.php?id=<?= htmlspecialchars($cat['id']) ?>" class="hover-text-glow-small"><?= htmlspecialchars($cat['name']) ?></a></li>
        <?php endforeach; ?>
      </ul>
      ...
      <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
        ...
        <li>
          ...
          <label for="home-toggle" class="hover-box-2">
            ...
            <a href="dashboard.php" class="back" onclick="event.stopPropagation();">Trang chủ</a>
          </label>
        </li>
        ...
        <li>
          ...
          <label for="cart-toggle" class="hover-box-2">
            ...
            <a href="cart.php" class="back" onclick="event.stopPropagation();">Giỏ hàng</a>
          </label>
        </li>
        ...
        <li class="nav-item">
          ...
          <ul class="dropdown" style="background-color:black;">
            ...
            <li><a href="index.php"><img src="images/exit.svg" /> Đăng xuất</a></li>
          </ul>
        </li>
        ...
        <li>
          ...
          <label for="search-toggle" class="hover-box-2">
            ...
            <a href="search.php" class="back" onclick="event.stopPropagation();">Tìm kiếm</a>
          </label>
        </li>
